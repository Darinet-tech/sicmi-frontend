...
import LayoutAdmin from "../../../components/usuario/LayoutAdmin";
    ...
    <Layout user={user} titulo="Admin" baseURL="./../">
      <LayoutAdmin>
        {!loading &&
          (user ? (
            <>
              <AddUsuario centrodecostos={centrodecostos} />
...
export async function getServerSideProps({ req, params }) {
  ...
  const usuariosResponse = await fetcher(
    `${process.env.NEXT_PUBLIC_STRAPI_URL}/usuarios?populate[0]=centrodecosto&pagination[page]=1&pagination[pageSize]=5`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
