...
export async function getServerSideProps({ req, params }) {
  ...
  const areasResponse = await fetcher(
    `${process.env.NEXT_PUBLIC_STRAPI_URL}/unidad?populate[0]=responsable&populate[1]=locales&filters[unidadorganizativa][id][$eq]=${uo}&pagination[page]=1&pagination[pageSize]=5`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
