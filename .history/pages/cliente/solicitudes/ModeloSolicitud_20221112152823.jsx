      ...
      >
        <Modal.Body css={{ paddingBottom: "80px" }}>
          <div ref={componentRef} style={{ margin: "10px" }}>
            ...
            <Table bordered>
              <Table.Header borderWeight>
                <Table.Column borderWeight>
              ...
              <Table.Body borderWeight>
                <Table.Row borderWeight>
                  <Table.Cell>
                ...
                <Table.Row borderWeight>
                  <Table.Cell>
                    <Text h6>Elaborado por:</Text>
                    <Text h6 css={{position:'absolute',right:'150px',bottom:'4px'}}>Firma</Text>
                  </Table.Cell>
                </Table.Row>
                <Table.Row borderWeight>
                  <Table.Cell>
