...
export default function all_recursos({ demanda_recursos }) {
...
export async function getServerSideProps({ req, params }) {
  ...
  const inmueblesResponse = await fetcher(
    `${process.env.NEXT_PUBLIC_STRAPI_URL}/recursos?populate[0]=centrodecosto&filters[unidadorganizativa][id][$eq]=${uo}`,
    {
      method: "GET",
      headers: {
