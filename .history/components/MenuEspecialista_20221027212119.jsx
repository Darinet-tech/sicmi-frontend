      ...
      >
        <Card.Body css={{ textAlign: "center" }}>
          <Grid.Container gap={1} justify="flex-start">
            <Grid xl={12}>
              <Dropdown>
                <Dropdown.Button light color="gradient" style={{ width:"100%"}}>SOLICITUD</Dropdown.Button>
                <Dropdown.Menu                
                  variant="light"
                  aria-label="Actions"
          ...
          <Grid.Container gap={1} justify="flex-start">
            <Grid xl={12}>
              <Dropdown>
                <Dropdown.Button light boedered color="gradient" style={{ width:"100%"}}>INMUEBLE</Dropdown.Button>
                <Dropdown.Menu
                  color="primary"
                  variant="light"
                  aria-label="Actions"
