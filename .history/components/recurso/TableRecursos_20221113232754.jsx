    ...
    <>
      ...
      <Grid>
        ...
        <Row>
          ...
          >
            <Table.Header>
              <Table.Column css={{ textAlign: "center", width:"30%" }}>CÓDIGO</Table.Column>
              <Table.Column css={{ textAlign: "center", width:"50%"  }}>
                NOMENCLADOR
              </Table.Column>
              <Table.Column css={{ textAlign: "center", width:"30%"  }}>PRECIO</Table.Column>
              <Table.Column css={{ textAlign: "center", width:"25%"  }}>
                LIBRE UTILIZACIÓN
              </Table.Column>
              <Table.Column css={{ textAlign: "center", width:"30%"  }}>UM</Table.Column>
