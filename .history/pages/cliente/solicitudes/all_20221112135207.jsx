...
export default function all_solicitudes({ solicitudes }) {
  ...
  const [modelo, setmodelo] = useState(second)
    ...
    <Layout user={user} titulo="Cliente" baseURL="./../../">
      <LayoutCliente>
        <>
          <Grid>
            <Row>
              <Button onClick={handlePrint}> Imprimir Reporte </Button> <Spacer/>
              <Button onPress={setmodelo(true)}>Mostrar Solicitud</Button>
              {/* <Button onClick={handlePrintModelo}> Imprimir Modelo de Solicitud </Button> */}
            </Row>
            <Row>
              {solicitudes.data && solicitudes.data.length > 0 ? (
                ...
                >
                  ...
                  <ModeloSolicitud componentRef={componentRefs}></ModeloSolicitud>
                </div>
              ) : (
