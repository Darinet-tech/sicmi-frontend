            ...
            <Grid xl={12}>
              <Dropdown>
                ...
                <Dropdown.Menu
                  ...
                  onAction={goto}
                >
                  <Dropdown.Item CSS={{weight="bold"}} key="listar_usuarios" color="primary">
                    USUARIOS
                  </Dropdown.Item>
                  <Dropdown.Item key="listar_uos" color="secondary">
                    UNIDAD ORGANIZATIVA
                  </Dropdown.Item>
                  ...
                  <Dropdown.Item key="listar_locales" color="primary">
                    LOCALES
                  </Dropdown.Item>
