      ...
      >
        <Modal.Body css={{ paddingBottom: "80px" }}>
          <div ref={componentRef} style={{ margin: "10px" }}>
            ...
            <Grid.Container css={{border:'1px solid black',padding:'5px'}} >
              <Grid xs={12} css={{border:'1px solid black',padding:'5px',textAlign: "center" }}>
              <Text h5 css={{ }}>
              ...
              <Grid xs={12} css={{border:'1px solid black',paddingBottom:'100px'}}>
