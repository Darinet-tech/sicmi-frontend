...
export default function ModeloSolicitud({solicitud}) {
  ...
  console.log(solicitud.attributes.local.data.attributes.arearesponsable.data.attributes.unidadorganizativa.data.attributes.nombre);
                  ...
                  >
                    ...
                    >
                      <b>
                        ...
                        >
                          Unidad Organizativa: &nbts {solicitud.attributes.local.data.attributes.arearesponsable.data.attributes.unidadorganizativa.data.attributes.nombre}
