    ...
    <>
      ...
      <Grid>
        ...
        <Row>
          ...
          >
            <Table.Header>
              <Table.Column css={{textAlign:"center" }}>CÓDIGO</Table.Column>
              <Table.Column css={{textAlign:"center" }}>NOMENCLADOR</Table.Column>
              <Table.Column css={{textAlign:"center" }}>PRECIO</Table.Column>
              <Table.Column css={{textAlign:"center" }}>LIBRE UTILIZACIÓN</Table.Column>
              <Table.Column css={{textAlign:"center" }}>UM</Table.Column>
              <S
