    ...
    <Layout user={user} titulo="Admin" baseURL="./../">
      <LayoutAdmin>
        {!loading &&
          (user ? (
            <>
              <AddUsuario roles={roles} uos={populate[0]=role&populate[1]=unidadorganizativa} />
...
export async function getServerSideProps({ req, params }) {
  ...
  const usuariosResponse = await fetcher(
    `${process.env.NEXT_PUBLIC_STRAPI_URL}/users?populate[0]=role&populate[1]=unidadorganizativa&pagination[page]=1&pagination[pageSize]=5`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
