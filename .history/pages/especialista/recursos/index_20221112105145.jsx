...
export default function recursos({ inmuebles }) {
  ...
  const { data } = useSWR(
    [
      `${process.env.NEXT_PUBLIC_STRAPI_URL}/recursos?populate[0]=demanda_recursos&filters[unidadorganizativa][id][$eq]=${uo}&pagination[page]=${pageIndex}&pagination[pageSize]=5`,
      {
        method: "GET",
        headers: {
