...
const TableSolicitudes = ({ solicitud }) => {
                      ...
                      <Table.Cell>
                        <Text b size={14}>
                          {solicitudItem.attributes.elaboradopor &&
                            solicitudItem.attributes.elaboradopor.data.map(
                              (elaboradoporItem) => {
                                return (
                                  <Text b size={14} key={elaboradoporItem.id}>
                                    {elaboradoporItem.attributes.username}
                                  </Text>
                                );
                              }
                            )}
