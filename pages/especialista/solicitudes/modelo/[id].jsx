...
import { Button, Grid, Image, Row } from "@nextui-org/react";
...
const modelo = ({ solicitud }) => {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: "Modelo-Solicitud-Materiales",
    onAfterPrint: () => {
      console.log("Modelo-Solicitud-Materiales generado exitosamente");
    },
  });
...
"
                  ...
                  <tr className="ro1">
                    ...
                    >
                      <p>
                        {
                          solicitud.data.attributes.local.data.attributes
                            .arearesponsable.data.attributes.unidadorganizativa
                  ...
                  <tr className="ro1">
                    ...
                    >
                      <p>
                        {
                          solicitud.data.attributes.local.data.attributes
                            .arearesponsable.data.attributes.nombre
                        }
                      </p>
                    </td>
                    <td
                  ...
                  <tr className="ro1">
                    ...
                    >
                      <p>
                        {
                          solicitud.data.attributes.local.data.attributes
                            .arearesponsable.data.attributes.centrodecosto
                        }
                      </p>
                    </td>
                    <td
                  ...
                  {solicitud.data.attributes.demanda_recursos &&
                    solicitud.data.attributes.demanda_recursos.data.length >
                      0 &&
                    solicitud.data.attributes.demanda_recursos.data.map(
                      (demandaItem) => {
                        return (
                          <tr className="ro1" key={demandaItem.id}>
                            <td
                              colSpan={4}
                              style={{ textAlign: "left", width: "0.9752in" }}
                              className="ce3"
                            ...
                            <td
                              ...
                              className="ce4"
                            >
                              <p>{demandaItem.attributes.demanda}</p>
                            </td>
                          </tr>
                        );
                      }
...
export async function getServerSideProps({ req, params }) {
  ...
  const solicitudResponse = await fetcher(
    `${process.env.NEXT_PUBLIC_STRAPI_URL}/solicitudes/${idsolicitud}?populate[0]=local&populate[1]=elaboradopor&populate[2]=demanda_recursos&populate[3]=ordenes_de_trabajos&populate[4]=local.arearesponsable&populate[5]=local.arearesponsable.unidadorganizativa&populate[6]=demanda_recursos.recurso`,
    {
      method: "GET",
      headers: {
