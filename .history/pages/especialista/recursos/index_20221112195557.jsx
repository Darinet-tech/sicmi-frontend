...
export default function recursos({ recursos }) {
  ...
  const { data } = useSWR(
    [
      `${process.env.NEXT_PUBLIC_STRAPI_URL}/recursos?&pagination[page]=${pageIndex}&pagination[pageSize]=10`,
      {
        method: "GET",
        headers: {
...
export async function getServerSideProps({ req, params }) {
  ...
  const recursosResponse = await fetcher(
    `${process.env.NEXT_PUBLIC_STRAPI_URL}/recursos?populate[0]=centrodecosto&filters[unidadorganizativa][id][$eq]=${uo}&pagination[page]=1&pagination[pageSize]=5`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
